                    ...
                    @foreach($all_product as $key => $pro)
                        <tr>
                            ...
                            <td><span class="text-ellipsis">
                                ...
                                ?>
                                    <a href="{{URL::to('/unactive-product/'.$pro->product_id)}}"><i class="fa fa-thumbs-styling fa-thumbs-down" aria-hidden="true"></i></a>

                                <?php
                                }else{
                                ?>
                                    <a href="{{URL::to('/active-product/'.$pro->product_id)}}"><i class="fa fa-thumbs-styling fa-thumbs-up" aria-hidden="true"></i></a>
                                <?php
                                }
                                ?>
