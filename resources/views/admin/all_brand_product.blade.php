                    ...
                    @foreach($all_brand_product as $key => $cate_pro)
                        <tr>
                            ...
                            <td><span class="text-ellipsis">
                                ...
                                ?>
                                    <a href="{{URL::to('/unactive-brand-product/'.$cate_pro->brand_id)}}"><i class="fa fa-thumbs-styling fa-thumbs-down" aria-hidden="true"></i></a>
                                
                                <?php
                                }else{
                                ?>
                                    <a href="{{URL::to('/active-brand-product/'.$cate_pro->brand_id)}}"><i class="fa fa-thumbs-styling fa-thumbs-up" aria-hidden="true"></i></a>
                                <?php
                                }
                                ?>
