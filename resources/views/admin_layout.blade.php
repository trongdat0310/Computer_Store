    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('public/backend/images/AnhDaiDien.jpg')}}">
                <span class="username">
                <?php
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/slider')}}">Quản lý hình ảnh slider</a></li>
                    </ul>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-slider')}}">Thêm silder</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
